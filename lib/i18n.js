...
const dictionaries = {
  zh: {
    ...
    'export.no': '否',
    'export.effShown': '可见',
    'export.effHidden': '已隐藏',
    'export.sheet.summary': '概览',
    'export.sheet.posts': '帖子',
    'export.sheet.comments': '评论',
    'export.sheet.reports': '举报记录',
    'export.sheet.words': '屏蔽词',
    'export.col.title': '标题',
    'export.col.content': '内容',
    'export.col.tag': '标签',
    'export.col.author': '作者',
    'export.col.likes': '点赞',
    'export.col.reports': '举报数',
    'export.col.commentCount': '评论数',
    'export.col.pinned': '置顶',
    'export.col.featured': '精华',
    'export.col.visibility': '可见性',
    'export.col.createdAt': '发布时间',
    'export.col.postId': '帖子 ID',
    'export.col.postTitle': '帖子标题',
    'export.col.targetType': '目标类型',
    'export.col.targetId': '目标 ID',
    'export.col.targetPreview': '目标摘要',
    'export.col.reporter': '举报人',
    ...
    'export.col.value': '数值',
    'export.col.pendingReports': '待处理举报',
    'export.col.totalReports': '举报总数',
  ...
  en: {
    ...
    'export.yes': 'Yes',
    'export.no': 'No',
    'export.effShown': 'visible',
    'export.effHidden': 'hidden',
    'export.sheet.summary': 'Summary',
    'export.sheet.posts': 'Posts',
    'export.sheet.comments': 'Comments',
    'export.sheet.reports': 'Reports',
    'export.sheet.words': 'Blocked words',
    'export.col.title': 'Title',
    'export.col.content': 'Content',
    'export.col.tag': 'Tag',
    'export.col.author': 'Author',
    'export.col.likes': 'Likes',
    'export.col.reports': 'Reports',
    'export.col.commentCount': 'Comments',
    'export.col.pinned': 'Pinned',
    'export.col.featured': 'Featured',
    'export.col.visibility': 'Visibility',
    'export.col.createdAt': 'Created at',
    'export.col.postId': 'Post ID',
    'export.col.postTitle': 'Post title',
    ...
    'export.col.pendingReports': 'Pending reports',
    'export.col.totalReports': 'Total reports',
